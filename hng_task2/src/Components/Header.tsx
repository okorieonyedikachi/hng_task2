      ...
      <div className="w-11/12 ">
        <div id="header" className="flex justify-between mt-10 max-sm:w-full">
          ...
          <div className="relative flex items-center w-1/2">
              <input type="text" className="w-full h-6 bg-transparent border rounded-md p-4 text-white max-sm:hidden" placeholder="What do you want to watch?"/>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute right-3 ">
